...
java -classpath "%~dp0\bin" -Xms16m -Xmx8192m com.asofterspace.picturizer.Picturizer %*
goto :end

:32bit
REM   we are running 32 bit - oh no! assign only a tinly little bit of heap!
java -classpath "%~dp0\bin" -Xms16m -Xmx1024m com.asofterspace.picturizer.Picturizer %*
