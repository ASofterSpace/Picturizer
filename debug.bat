...
start "Picturizer" java -classpath "%~dp0\bin" -Xms16m -Xmx4096m com.asofterspace.picturizer.Main %*
goto :end

:32bit
REM   we are running 32 bit - oh no! assign only a tinly little bit of heap!
start "Picturizer" java -classpath "%~dp0\bin" -Xms16m -Xmx1024m com.asofterspace.picturizer.Main %*
